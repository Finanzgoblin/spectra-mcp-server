...
- Spectra API base: `https://api.spectra.finance/v1` (primary); app API: `https://app.spectra.finance/api/v1` (numeric endpoints)
...
- `resolveNetwork()` maps user-facing chain names to API network names (e.g., "ethereum" → "mainnet")
